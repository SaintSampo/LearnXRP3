...
- **F: Two doors, two ways in** — the demo's layout (A plus C) with an age bar above the doors: "Under 18 · students" over the blue door, "18 and over · teachers, mentors, parents" over the white one. The student door keeps code-and-name as the primary path and adds "Sign in with school Google" beneath a divider, with the rules spelled out: school accounts only, under 13 needs the class switch, hashed ID kept, email discarded.
- **G: Age first** — one question before anything else: "I'm under 18" or "I'm 18 or older", as two big buttons. Under 18 shows two ways side by side, code on the board (the usual way) and school Google account. 18 or older shows the adult sign-in. The age answer is a fork, not a record.
