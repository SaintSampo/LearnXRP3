...
- **F: Two doors, two ways in** — the demo's layout (A plus C) with a role bar above the doors: "Students" over the blue door, "Adults · teachers, mentors, parents" over the white one. No age numbers, at Jacob's request. The student door keeps code-and-name as the primary path and adds "Sign in with school Google" beneath a divider, with the rules spelled out: school accounts only, under 13 needs the class switch, hashed ID kept, email discarded.
